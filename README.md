...
useRouteMatch is a react hook that we use with <Route> when trying to match URL data

2. How would you explain form validation to someone who has never programmed before?
Form validation is a procedure to make sure that the data entered by the user is appropriate for what the form requires. This can prevent errors and mishandle data

3. In 1-2 sentences, define end to end testing.
End-to-end testing involves testing a project from the beginning to the end. This method duplicates user interatction scenarios to find errors, bugs, broken code, etc., before shipping a product.
